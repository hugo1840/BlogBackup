...
modified: '2022-12-12T02:57:20.140Z'
---
...
[root@oraclehost app]# su - oracle
[oracle@oraclehost ~]$ export ORACLE_SID=+ASM
[oracle@oraclehost ~]$ export ORACLE_HOME=/u01/app/oracle/product/19.0.0/grid

# 挂载磁盘组DATADG
[oracle@oraclehost ~]$ $ORACLE_HOME/bin/asmcmd mount DATADG

# 检查磁盘组和ASM磁盘
[oracle@oraclehost ~]$ $ORACLE_HOME/bin/asmcmd lsdg
[oracle@oraclehost ~]$ $ORACLE_HOME/bin/asmcmd lsdsk
```
